...
public class ScooterTestOrdering {
    ...
    public static Object[][] Parameters() {
        return new Object[][] {
                {cssSelector("div.Header_Nav__AGCXC > button.Button_Button__ra12g"), "Осипов", "Дмитрий", "Щелково Пролетарский проспект дом 3 квартира 159", "89250914255", "Позвонить за час до доставки"},
                {cssSelector("div.Home_RoadMap__2tal_ > div.Home_FinishButton__1_cWm > button"), "Осипов", "Дмитрий", "Щелково Пролетарский проспект дом 3 квартира 159", "89250914255", "Позвонить за час до доставки"}
        };
    }
    @Test
